	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','storage_age_of_goods') || $check_field('add','storage_age_of_goods') || $check_field('set','storage_age_of_goods')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="货物库龄" prop="storage_age_of_goods">
					<el-input id="storage_age_of_goods" v-model="form['storage_age_of_goods']" placeholder="请输入货物库龄"
	...
	export default {
		...
		data() {
			return {
				...
				form: {
					"name_of_goods":'', // 货物名称
					"goods_no":this.$get_stamp(), // 货物编号
					"cargo_volume":'', // 货物体积
					"cargo_weight":'', // 货物重量
					"location":'', // 所在货位
					"storage_age_of_goods":'', // 货物库龄
